object FR_Usuario: TFR_Usuario
  ...
  object Notebook1: TNotebook
    ...
    object TPage
      ...
      object ED_Usuario_Consulta: TEdit
        Left = 61
        Top = 43
        Width = 172
        Height = 21
        CharCase = ecUpperCase
        TabOrder = 0
        OnChange = ED_Usuario_ConsultaChange
        OnKeyPress = ED_Usuario_ConsultaKeyPress
      end
      object DBGrid1: TDBGrid
        ...
        Width = 762
        Height = 187
        DataSource = Modulo1.DS_Q_Usuarios
        TabOrder = 3
    ...
    object TPage
      ...
      object GB_Login: TGroupBox
        ...
        object CB_Administrador: TCheckBox
          Left = 437
          Top = 31
          Width = 97
          Height = 17
        ...
        object CB_Mensagem_Tela_Principal: TCheckBox
          Left = 545
          Top = 31
          Width = 158
          Height = 17
          Caption = 'Mensagem Tela Principal'
          TabOrder = 3
        end
      end
    end
